...
import {dellAllCart} from "../redux/actions/cartAC";
            ...
            <div className="container container--cart">
                <div className="cart">
                    <div className="cart__top">
                        ...
                        <Link to="/">
                            <Button buttonOnClick={onDelCart} className="cart__clear">
                    ...
                    <div className="cart__bottom">
                        <div className="cart__bottom-details">
                            <span> Всего пицц: <b>{selectors.totalCount} шт.</b> </span>
                            <span> Сумма заказа: <b>{selectors.totalPrice} грн</b> </span>
                        </div>
